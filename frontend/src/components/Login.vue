...
<script type="text/javascript">
  ...
  export default {
    ...
    methods : {
      ...
      googleUrl () {
        let url = 'https://accounts.google.com/o/oauth2/v2/auth?scope=email&response_type=token&client_id=1014326414498-kep51hfte7ml514t37vgrmjj1f0hnosl.apps.googleusercontent.com&redirect_uri=http://localhost:8080/token';
        location.assign(url);
      }
    }
  }
